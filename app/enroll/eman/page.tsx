...
export const metadata: Metadata = {
  title: "Eman — US Admissions Program | Himmah Prep",
  description:
    "Select your admissions plan for Eman. July 2026 – March 2027.",
