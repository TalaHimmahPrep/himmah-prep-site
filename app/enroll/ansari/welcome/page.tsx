...
export default function AnsariWelcomePage() {
    ...
    <main className="enroll-page">
      <header className="enroll-header">
        ...
        {status === "ok" ? (
          ...
          <>
            <p className="eyebrow">Welcome, Ansari Family</p>
            <h1 className="enroll-title serif">
        ...
        <section className="intake-form-wrap">
          <form className="intake-form" onSubmit={onSubmit} noValidate>
            <fieldset className="intake-fieldset">
              ...
              <label className="intake-label">
                <span>Extracurriculars, awards, and leadership roles</span>
                <textarea
            ...
            <fieldset className="intake-fieldset">
              ...
              {[1, 2, 3, 4, 5].map((n) => (
                <label className="intake-label" key={n}>
                  <span>
                    School {n}
                    {n === 1 && <span className="intake-req"> *</span>}
                  </span>
                  <input
                    type="text"
                    name={`dreamSchool${n}`}
            ...
            <fieldset className="intake-fieldset">
              ...
              <label className="intake-label">
                ...
                <input type="text" name="parentName" required autoComplete="name" />
              </label>
